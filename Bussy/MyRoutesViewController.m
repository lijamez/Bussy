...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UITableViewCell * cell = [self getFancyCellForTableView:tableView cellForRowAtIndexPath:indexPath];
    
    UILabel * routeNumberLabel = (UILabel*) [cell viewWithTag:ROUTE_NUMBER_LABEL_TAG];
    UILabel * routeTimesLabel = (UILabel*) [cell viewWithTag:ROUTE_TIMES_LABEL_TAG];
    UILabel * routeNameLabel = (UILabel*) [cell viewWithTag:ROUTE_NAME_LABEL_TAG];
